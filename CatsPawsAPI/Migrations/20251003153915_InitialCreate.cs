    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialTopics", x => new { x.MaterialId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_MaterialTopics_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "MaterialId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialTopics_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskStatusHistory", x => x.TaskStatusId);
                    table.ForeignKey(
                        name: "FK_TaskStatusHistory_TaskStatuses_StatusId",
                        column: x => x.StatusId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskStatusHistory_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestResults", x => x.UserTestId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialTopics_TopicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusHistory_StatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusHistory_UserId",
                table: "TaskStatusHistory",
                column: "UserId");
